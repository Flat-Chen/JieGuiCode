...
class CarSpider(scrapy.Spider):
    ...
    def get_url_list(self):
        huachen_df = pd.read_sql("select id,url from che58_online where price1 is null ", con=self.engine_huachen)
    ...
    def start_requests(self):
        ...
        for url in url_list:
            ...
            # id=1
            yield scrapy.Request(url=start_url, headers=self.headers1, meta={'id': id, 'url': start_url},dont_filter=True)

    def save_data(self, id, mileage):
        sql = 'update che58_online set price1 ={} where id ={}'.format(mileage, id)
    ...
    def deal_font(self):
        ...
        # linux
        font = TTFont('/home/home/che58_font/che58_price.ttf')
    ...
    def parse(self, response):
        if '您搜索的二手车已经被其他买家买走了' in response.text:
        # 车未被买走
            mileage = response.xpath(
                '//ul[@class="info-meta-s h-clearfix"]//span[@class="info-meta_val"]/text()').extract_first()
        ...
        # 车被买走
            ...
            mileage = response.xpath(
                "//div[@class='info-price']/em/text()").extract_first()
            ...
            with open("/home/home/che58_font/che58_price.ttf", "bw") as f:
