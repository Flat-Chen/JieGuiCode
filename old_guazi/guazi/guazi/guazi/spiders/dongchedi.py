...
class GuazicarSpider(scrapy.Spider):
    ...
    one_url = "https://www.dcdapp.com/motor/discuss_ugc/cheyou_feed_list_v3/v1/?motor_id={}&channel=m_web&device_platform=wap&koubei=dongtai&cmg_flag=koubei&min_behot_time=&max_behot_time=&max_cursor=&web_id=0&device_id=0&impression_info=%7B%22page_id%22%3A%22page_forum_home%22%2C%22product_name%22%3A%22pc%22%7D&tt_from=load_more"
    seconde_url = "https://www.dcdapp.com/motor/discuss_ugc/cheyou_feed_list_v3/v1/?motor_id={}&channel=m_web&device_platform=wap&category=koubei&cmg_flag=koubei&min_behot_time=&max_behot_time=&max_cursor={}&web_id=0&device_id=0&impression_info=%7B%22page_id%22%3A%22page_forum_home%22%2C%22product_name%22%3A%22pc%22%7D&tt_from=load_more"
    ...
    def parse(self, response):
        ...
        for series in series_list:
            ...
            url = "https://www.dcdapp.com/auto/series/" + str(series_id)
